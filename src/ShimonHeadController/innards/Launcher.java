package ShimonHeadController.innards;
...
import ShimonHeadController.innards.namespace.context.ContextTree;
 ...
 * <p>
 * Usage: java ShimonHeadController.innards.Launcher [-property1 value1] [-p2 v2] . . .              <br>
 ...
 * use subclasses of ShimonHeadController.innards.util.ShutdownHook.  See the documentation in that class for more details.
 * <p>
 ...
 * <p>
 * 
 * @see ShimonHeadController.innards.iLaunchable
 * @see ShimonHeadController.innards.iUpdateable
 * @see ShutdownHook
 * //@see ShimonHeadController.innards.util.MenuManager
 * @see InnardsDefaults
 * 
 * @author many
*/
public class Launcher
{
	...
	private Launcher()
	{
		...
		}, "ShimonHeadController.Main Launcher Shutdown Hook"));
	}
	...
	{
		System.err.println("Usage: java ShimonHeadController.innards.Launcher [-property1 value1] [-p2 v2] . . .");
