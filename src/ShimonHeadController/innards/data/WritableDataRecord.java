package ShimonHeadController.innards.data;
 ...
 * @see ShimonHeadController.innards.iWritableDataRecord
 * @author synchar
 */
public class WritableDataRecord extends NamedObject implements iWritableDataRecord
{
	...
	* Allows you to create a WritableDataRecord using an existing map.
	...
	/**
	 * @see ShimonHeadController.innards.iWritableDataRecord#putData(ShimonHeadController.innards.Key, Object)
	 */
	...
	/**
	* @see ShimonHeadController.innards.iDataRecord#getData(ShimonHeadController.innards.Key)
	*/
	...
	/**
	 * @see ShimonHeadController.innards.iWritableDataRecord#removeEntry(ShimonHeadController.innards.Key)
	 */
	...
	/**
	 * @see ShimonHeadController.innards.iDataRecord#hasKey(ShimonHeadController.innards.Key)
	 */
	...
	/**
	 * @see ShimonHeadController.innards.iDataRecord#getKeySet()
	 */
	...
	/**
	 * @see ShimonHeadController.innards.iWritableDataRecord#getReadOnlyView()
	 */
	...
	/**
		@see ShimonHeadController.innards.iDataRecord#getWritableCopy()
		*/
	public iWritableDataRecord getWritableCopy()
	{
