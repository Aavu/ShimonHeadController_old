package ShimonHeadController.innards.input;

import ShimonHeadController.innards.Key;
import ShimonHeadController.innards.data.iDataRecord;
 ...
 * 
 * @see InputDevice
 * @see ShimonHeadController.innards.input.iDataRecordHandler
 * @author synchar
 */
public class InputDispatcher implements iUpdateable
{
	 ...
	 * @see ShimonHeadController.innards.iUpdateable#update()
	 */
	public void update()
	{
