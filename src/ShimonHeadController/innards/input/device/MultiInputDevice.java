package ShimonHeadController.innards.input.device;

import ShimonHeadController.innards.Key;
import ShimonHeadController.innards.data.*;
import ShimonHeadController.innards.debug.Debug;
import ShimonHeadController.innards.input.*;
...
{	
	 ...
	 * @see ShimonHeadController.innards.input.InputDevice#getInput()
	 * @return ShimonHeadController.innards.iDataRecord Data for each member device is indexed by
	 * that device's key.
	 */
