package ShimonHeadController.innards.math.kalman;
...
public class EKFVec
{
    ...
    */
    ...
    /**
       Mimics Vec.get()
       @see ShimonHeadController.innards.math.linalg.Vec#get(int)
    */
    public double get(int n) {return state.get(n);}

    /**
       Mimics Vec.set()
       @see ShimonHeadController.innards.math.linalg.Vec#set(int, double)
    */
    public void set(int n, double val) {state.set(n, val);}

    /**
       Mimics Vec.size()
       @see ShimonHeadController.innards.math.linalg.Vec#size()
    */
