package ShimonHeadController.innards.math.util;

import ShimonHeadController.innards.util.Conversions;
...
public class Fft {
    ...
    */
    ...
    /**
       Class for storing the results of a double-precision FFT operation performed by ShimonHeadController.innards.math.util.Fft.
    */
...
//            System.out.println("1 " + indexToHertz(1) + " 2 " + indexToHertz(2));
	...
	*/
    ...
    /**
       Class for storing the results of a short-int-precision FFT operation performed by ShimonHeadController.innards.math.util.Fft.
    */
