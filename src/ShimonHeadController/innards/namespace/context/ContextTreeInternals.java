...
import ShimonHeadController.innards.provider.*;
...
public class ContextTreeInternals
{
	...
	protected static float resolveNumber(Object o)
	{
		...
		if (o instanceof ShimonHeadController.innards.math.linalg.Vec)
			return (float) ((ShimonHeadController.innards.math.linalg.Vec) o).mag();
		if (o instanceof ShimonHeadController.innards.math.linalg.Vec3)
			return (float) ((ShimonHeadController.innards.math.linalg.Vec3) o).mag();
		if (o instanceof ShimonHeadController.innards.math.linalg.Vec2)
			return (float) ((ShimonHeadController.innards.math.linalg.Vec2) o).mag();
