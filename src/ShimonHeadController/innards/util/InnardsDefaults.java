...
import ShimonHeadController.innards.math.linalg.Vec2;
...
public class InnardsDefaults
{
	...
	protected static void setupLogging(){
		...
		//maybe it would be cleaner to copy default-defaults into ShimonHeadController.innards defaults with a function here, in ShimonHeadController.innards defaults?
