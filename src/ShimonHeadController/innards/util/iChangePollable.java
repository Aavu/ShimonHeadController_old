...
A typical implementation will look like this:
	...
	that typically live in ShimonHeadController.innards.  But it's not in the UI folder because we don't
	want anything from ShimonHeadController.innards to have to point to anything in UI.  So this file
	lives in UI.		
*/
